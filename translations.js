...
const translations = {
  ...
  why_4_title:        { en: "12-Clinic Network",
                        es: "Red de 12 Clínicas" },
  why_4_desc:         { en: "Across Texas, Florida, and Georgia, our US network combines immediate access and same-day appointments across all our clinics.",
                        es: "En Texas, Florida y Georgia, nuestra red combina acceso inmediato y citas el mismo día en todas nuestras clínicas." },
  ...
  loc_table_header_name:  { en: "Clinic Name", es: "Nombre de la clínica" },
  loc_table_header_city:  { en: "City", es: "Ciudad" },
  loc_table_header_state: { en: "State", es: "Estado" },
  loc_table_header_phone: { en: "Phone", es: "Teléfono" },
  loc_table_header_hours: { en: "Hours", es: "Horario" },
  loc_row_1_name: { en: "HealthCore Austin Central", es: "HealthCore Austin Central" },
  loc_row_1_city: { en: "Austin", es: "Austin" },
  loc_row_1_hours: { en: "Mon-Fri 7am-8pm · Sat 9am-3pm", es: "Lun-Vie 7am-8pm · Sab 9am-3pm" },
  loc_row_2_name: { en: "HealthCore Austin North", es: "HealthCore Austin North" },
  loc_row_2_city: { en: "Austin", es: "Austin" },
  loc_row_2_hours: { en: "Mon-Fri 8am-7pm", es: "Lun-Vie 8am-7pm" },
  loc_row_3_name: { en: "HealthCore San Antonio", es: "HealthCore San Antonio" },
  loc_row_3_city: { en: "San Antonio", es: "San Antonio" },
  loc_row_3_hours: { en: "Mon-Fri 8am-6pm · Sat 9am-1pm", es: "Lun-Vie 8am-6pm · Sab 9am-1pm" },
  loc_row_4_name: { en: "HealthCore Miami", es: "HealthCore Miami" },
  loc_row_4_city: { en: "Miami", es: "Miami" },
  loc_row_4_hours: { en: "Mon-Fri 7am-8pm · Sat 9am-4pm", es: "Lun-Vie 7am-8pm · Sab 9am-4pm" },
  loc_row_5_name: { en: "HealthCore Orlando", es: "HealthCore Orlando" },
  loc_row_5_city: { en: "Orlando", es: "Orlando" },
  loc_row_5_hours: { en: "Mon-Fri 8am-6pm", es: "Lun-Vie 8am-6pm" },
  loc_row_6_name: { en: "HealthCore Atlanta", es: "HealthCore Atlanta" },
  loc_row_6_city: { en: "Atlanta", es: "Atlanta" },
  loc_row_6_hours: { en: "Mon-Fri 8am-7pm", es: "Lun-Vie 8am-7pm" },
  ...
  footer_hq_phone:    { en: "+1-512-340-8800",
                        es: "+1-512-340-8800" },
